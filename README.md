...
깃허브를 사용해서 프로젝트를 진행해 보는건 처음이 아니었지만, organization을 만들고 다른 사람들과 협업하여 프로젝트를 진행하는 것은 처음이었습니다. 보통은 친구들과 프로젝트를 진행했기 때문에 모든 것을 구두로 진행하였습니다. 이번 프로젝트를 진행하면서 이슈와 태그 등을 배우고 사용하면서 기록을 남기는 방법, 버전관리 방법, 브랜치의 활용법 등을 익히면서 협업하는 법을 새로이 배운것 같아 굉장히 유의미한 경험이었습니다. 아쉬운 점으로 개발 기간이 생각보다 많이 적어서 아쉬웠습니다. 기획을 하면서 이게 있으면 보다 좋지 않을까, 이 기능을 추가하면 정말 재밌지 않을까라는 생각을 많이 했습니다. 하지만 적은 개발 기간때문에 기능에 대해서는 타협을 하면서 아쉬운점이 많았습니다. 개발기간이 좀더 많았으면 구현 가능했을 거 같았는데 이것 또한 팀 프로젝트의 묘미라고 생각했습니다. 다음에 또 다른 협업 프로젝트를 진행하면 이 경험이 밑거름이 되어 보다 개선된 프로젝트가 될 것이라는 생각을 했고 좋은 경험이었다고 생각했습니다. 
